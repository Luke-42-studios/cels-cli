...
static const char* TMPL_MAIN_MENU =
    ...
    "\n"
    "    Widget_Canvas(.title = \"%s\") {}\n"
    "    Widget_Button(.label = \"Start\",    .selected = (menu->selected == 0)) {}\n"
    "    Widget_Button(.label = \"Settings\", .selected = (menu->selected == 1)) {}\n"
    "    Widget_Button(.label = \"Quit\",     .selected = (menu->selected == 2)) {}\n"
    "    Widget_Hint(.text = \"[W/S: Navigate | Enter: Select | Q: Quit]\") {}\n"
    "    Widget_StatusBar(.left = \"%s v0.1.0\", .right = \"q:quit \") {}\n"
    "}\n"
    "\n"
    ...
    "\n"
    "    Widget_Canvas(.title = \"Settings\") {}\n"
    "    Widget_Toggle(.label = \"Fullscreen\", .value = cfg->fullscreen, .selected = (menu->selected == 0)) {}\n"
    "    Widget_Toggle(.label = \"VSync\",      .value = cfg->vsync,      .selected = (menu->selected == 1)) {}\n"
    "    Widget_Button(.label = \"Back\",       .selected = (menu->selected == 2)) {}\n"
    "    Widget_Hint(.text = \"[W/S: Navigate | A/D: Toggle | Enter/Esc: Back]\") {}\n"
    "    Widget_StatusBar(.left = \"settings\", .right = \"esc:back \") {}\n"
    "}\n"
    "\n"
